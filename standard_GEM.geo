...
ref= 20; // Essa grandeza diz respeito ao refinamento da mesh que será gerada. Quando menor o valor de ref maior o refinamento
ref2 = 10; // Ref do furo
...
Z_c=10000; //Distancia do catodo (cede elétrons) ao topo do cobre

Z_a=-1000; //Distancia do anodo (recebe elétrons) ao cobre de baixo

//-------Z_k-----------------------------------------------------------------------------------------------
Point(101) = {0, 0, Z_k, ref2};
Point(102) = {0, R_d, Z_k, ref2};
Point(103) = {0, h, Z_k, ref2};
Point(104) = {-x+R_d, h, Z_k, ref2};
Point(105) = {-x, h, Z_k, ref};
Point(106) = {-x, h-R_d, Z_k, ref};
Point(107) = {-x, 0, Z_k, ref};
Point(108) = {-R_d, 0, Z_k, ref2};


//-------Z_k+E_d/2-----------------------------------------------------------------------------------------------
Point(201) = {0, 0, Z_k+E_d/2, ref2};
Point(202) = {0, R_c, Z_k+E_d/2, ref2};
Point(203) = {0, h, Z_k+E_d/2, ref2};
Point(204) = {-x+R_c, h, Z_k+E_d/2, ref2};
Point(205) = {-x, h, Z_k+E_d/2, ref2};
Point(206) = {-x, h-R_c, Z_k+E_d/2, ref2};
Point(207) = {-x, 0, Z_k+E_d/2, ref2};
Point(208) = {-R_c, 0, Z_k+E_d/2, ref2};

//-------Z_k-E_d/2-----------------------------------------------------------------------------------------------
Point(301) = {0, 0, Z_k-E_d/2, ref2};
Point(302) = {0, R_c, Z_k-E_d/2, ref2};
Point(303) = {0, h, Z_k-E_d/2, ref2};
Point(304) = {-x+R_c, h, Z_k-E_d/2, ref2};
Point(305) = {-x, h, Z_k-E_d/2, ref2};
Point(306) = {-x, h-R_c, Z_k-E_d/2, ref2};
Point(307) = {-x, 0, Z_k-E_d/2, ref2};
Point(308) = {-R_c, 0, Z_k-E_d/2, ref2};

//-------Z_k+E_d/2+E_c-----------------------------------------------------------------------------------------------
Point(401) = {0, 0, Z_k+E_d/2+E_c, ref2};
Point(402) = {0, R_c, Z_k+E_d/2+E_c, ref2};
Point(403) = {0, h, Z_k+E_d/2+E_c, ref2};
Point(404) = {-x+R_c, h, Z_k+E_d/2+E_c, ref2};
Point(405) = {-x, h, Z_k+E_d/2+E_c, ref2};
Point(406) = {-x, h-R_c, Z_k+E_d/2+E_c, ref2};
Point(407) = {-x, 0, Z_k+E_d/2+E_c, ref2};
Point(408) = {-R_c, 0, Z_k+E_d/2+E_c, ref2};

//-------Z_k-E_d/2-E_c-----------------------------------------------------------------------------------------------
Point(501) = {0, 0, Z_k-E_d/2-E_c, ref2};
Point(502) = {0, R_c, Z_k-E_d/2-E_c, ref2};
Point(503) = {0, h, Z_k-E_d/2-E_c, ref2};
Point(504) = {-x+R_c, h, Z_k-E_d/2-E_c, ref2};
Point(505) = {-x, h, Z_k-E_d/2-E_c, ref2};
Point(506) = {-x, h-R_c, Z_k-E_d/2-E_c, ref2};
Point(507) = {-x, 0, Z_k-E_d/2-E_c, ref2};
Point(508) = {-R_c, 0, Z_k-E_d/2-E_c, ref2};
...
//+
Physical Volume(1) = {1}; //catodo
//+
Physical Volume(2) = {2}; //top
//+
Physical Volume(3) = {3}; //bottom
//+
Physical Volume(4) = {4}; //anodo
